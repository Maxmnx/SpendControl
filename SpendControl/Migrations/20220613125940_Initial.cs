        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transportations_Warehouses_SenderWarehouseId",
                        column: x => x.SenderWarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Transportations_Warehouses_TargetWarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    canAddMaterials = table.Column<bool>(type: "bit", nullable: false),
                    canUseMaterials = table.Column<bool>(type: "bit", nullable: false),
                    canDeleteMaterials = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transportations_SenderWarehouseId",
                table: "Transportations",
                column: "SenderWarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_Transportations_TargetWarehouseId",
                table: "Transportations",
